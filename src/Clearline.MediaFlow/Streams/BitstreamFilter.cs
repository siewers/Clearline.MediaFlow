...
public enum BitstreamFilter
{
    ...
    /// <summary>
    ///     Extract Rgb or Alpha part of an HAPQA file, without recompression, in order to create an HAPQ or an HAPAlphaOnly
    ///     file.
    /// </summary>
    hapqa_extract,
    ...
    /// <summary>
    ///     This applies a specific fixup to some Blu-ray streams which contain redundant PPSs modifying irrelevant parameters
    ///     of the stream which confuse other transformations which require correct extradata.
    /// </summary>
    h264_redundant_pps,
    ...
    /// <summary>
    ///     Convert an HEVC/H.265 bitstream from length prefixed mode to start code prefixed mode (as defined in the Annex B of
    ...
    /// <summary>
    ///     Damages the contents of packets or simply drops them without damaging the container. Can be used for fuzzing or
    ...
    /// <summary>
    ///     Merge VP9 invisible (alt-ref) frames back into VP9 superframes. This fixes merging of split/segmented VP9 streams
    ///     where the alt-ref frame was split from its visible counterpart.
    /// </summary>
    vp9_superframe,
    ...
    /// <summary>
    ///     Given a VP9 stream with correct timestamps but possibly out of order, insert additional show-existing-frame packets
