...
public interface IInputBuilder
{
    ...
    /// <summary>
    ///     Prepares a list of files to be used as input by renaming them to have a consistent file name and copying them to
    ///     the temp directory
    /// </summary>
    ...
    Func<string, string> PrepareInputFiles(IEnumerable<MediaLocation> files, out string directory);
}
